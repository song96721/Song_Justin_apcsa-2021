...
public class Magpie4
{
    ...
    else if (findKeyword(statement, "Mauro") >= 0)
  {
   response = "That's great!";
    ...
    else if (findKeyword(statement, "hamburgers") >= 0
    || findKeyword(statement, "fries") >= 0)
  {
  ...
  {
   response = "My favorite sports.";
  }
    else if (findKeyword(statement, "league of legends") >= 0
    || findKeyword(statement, "rocket league") >= 0)
  {
   response = "My favorite games.";
  }
  ...
  private String transformIYouStatement(String statement)
    ...
    String restOfStatement = statement.substring(2, psn1).trim();
		//restOfStatement = statement.substring(2).trim();
